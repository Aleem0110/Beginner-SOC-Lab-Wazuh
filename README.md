...
![VirtualBox Dashboard](Screenshots/01-Virtualbox-Dashboard.png)

### VirtualBox Ubuntu Wazuh Setup
![VirtualBox Ubuntu](Screenshots/09-VirtualBox_Ubuntu_Wazuh.png)

### Wazuh Login Page
![Login](Screenshots/11-wazuh_login_page.png)

### Wazuh Dashboard
![Dashboard](Screenshots/12-wazuh-Dashboard.png)

### Agent Deployment Command
![Deployment Command](Screenshots/agent-deployment-command.png)
